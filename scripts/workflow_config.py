...
try:
    from scripts import workflow_normalization as _workflow_normalization
except ModuleNotFoundError:  # pragma: no cover - direct script-style imports
    import workflow_normalization as _workflow_normalization  # type: ignore

NormalizationDependencies = _workflow_normalization.NormalizationDependencies
...
def _normalization_dependencies() -> NormalizationDependencies:
    return NormalizationDependencies(
        values={
            ...
            "InputBindingPlan": InputBindingPlan,
            "OutputPlan": OutputPlan,
            "LoopSourceBinding": LoopSourceBinding,
            "CollectionExportPlan": CollectionExportPlan,
            "StepPlan": StepPlan,
            "LoopPlan": LoopPlan,
            "WorkflowPlan": WorkflowPlan,
            "IssueCollector": _IssueCollector,
            "WorkflowConfigError": WorkflowConfigError,
        }
    )
...
def normalize_workflow_config(
    ...
    *,
    ...
    """Normalize a parsed DTO through the pure normalization module."""

    return _workflow_normalization.normalize_declaration(
        config,
        source_path=source_path,
